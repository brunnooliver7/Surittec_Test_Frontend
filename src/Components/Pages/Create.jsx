...
export default class Create extends Component {
    ...
    constructor (props) {
        ...
        this.state = {
            ...
            cliente_email: [{email: ''}],
            nomeErro1: 'Este campo é obrigatório',
            nomeErro2: '',
            cpfErro: 'Este campo é obrigatório',
            enderecoErro: [{
            ...
            telefoneErro: [{numero: 'Este campo é obrigatório'}],
            emailErro: [{email: 'Este campo é obrigatório'}],
            alert_msg: {
                Success: '',
                NomeFail: '',
                CpfFail: '',
        ...
        return (
            <div className="create-page-body">
                ...
                <form
                    ...
                    className="criar-btn-form"
                >
                    <input type="submit" value="Criar Cliente" className="btn btn-primary btn-lg"/>
                </form>
            </div>
        )
    }
